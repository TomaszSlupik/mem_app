      ...
      <ThemeProvider theme={props.changeColorLayout}>
        <div className="viewcard__box">
          ...
          <IconButton
            ...
            color="inherit"
          >
            <PublicIcon style={style.setting} color="primary" />
          </IconButton>
          <Menu
            id="menu-appbar"
          ...
          >
            ...
            <MenuItem onClick={handlerChangeLanguageEN}>
              <img
                className="viewcard__box-img"
                src="/mem_app/img/unitedkingdom.png"
                alt="Flaga Wielkiej Brytani"
              />
